...
namespace FitnessApp_PreslavZlatinov_19621621.Migrations
{
    ...
    [Migration("20230521134005_Workouts_Additional_Fields")]
    partial class Workouts_Additional_Fields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitnessApp_PreslavZlatinov_19621621.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("FitnessApp_PreslavZlatinov_19621621.Models.Order", b =>
                {
                    b.HasOne("FitnessApp_PreslavZlatinov_19621621.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FitnessApp_PreslavZlatinov_19621621.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
